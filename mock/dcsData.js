 ...
 * @LastEditTime: 2020-06-28 15:50:06
    ...
    response: config => {
      const data = Mock.mock({
        ...
        perDayDataVo: {
          ...
          // 地区交易率排名
          'zoneNo04402Count|5-100000': 21,
          'zoneNo02302Count|5-100000': 21,
          'zoneNo02303Count|5-100000': 21,
          'zoneNo02304Count|5-100000': 21,
          'zoneNo02305Count|5-100000': 21,
          'zoneNo02306Count|5-100000': 21,
          'zoneNo02307Count|5-100000': 21,
          'zoneNo02308Count|5-100000': 21,
          'zoneNo02309Count|5-100000': 21,
          'zoneNo02310Count|5-100000': 21,
          'zoneNo02312Count|5-100000': 21,
          'zoneNo02313Count|5-100000': 21,
          'zoneNo02314Count|5-100000': 21,
          'zoneNo02315Count|5-100000': 21,
          'zoneNo02316Count|5-100000': 21,
          'zoneNo02317Count|5-100000': 21,
          'zoneNo02318Count|5-100000': 21,
          'zoneNo02319Count|5-100000': 21,
          'zoneNo02320Count|5-100000': 21,
          'zoneNo02321Count|5-100000': 21,
          'zoneNo02322Count|5-100000': 21,
          // 渠道总类交易占比
      ...
      /** 饼图数据处理 */
      let apiRequestCount = Number(randomNum(2, 7))
      let getApipSeqnoCount = 3
      let qryTrxApipSeqnoCount = 12 - 3 - apiRequestCount
      let apiRequestCountDay = Number(randomNum(2, 7))
      let getApipSeqnoCountDay = 3
      let qryTrxApipSeqnoCountDay = 12 - 3 - apiRequestCountDay
      ...
      // let throughputMap = []
      // data.throughputMap.throughputMap.forEach(n => {
      //   throughputMap.push(n.value)
      // })
      return {
        code: 200,
        msg: '服务器错误',
        data: {
          ...
          throughputMap: data.throughputMap.throughputMap,
